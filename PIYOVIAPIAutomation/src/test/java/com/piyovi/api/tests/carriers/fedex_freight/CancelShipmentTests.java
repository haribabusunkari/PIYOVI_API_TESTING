...
public class CancelShipmentTests extends BasePage {
    ...
    public void testRateRequestOK() {
        logger = extent.createTest("FedEx Freight API - Test Basic Cancel Shipment ", "Verify Basic Cancel Shipment");

        var fileHelper = new FileHelper();
        var payload = fileHelper.getFile(carriersPayLoadPath + FedExFrieghtConstants.CANCEL_SHIPMENTT_PAYLOAD);
